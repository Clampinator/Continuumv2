...
export async function prepareSheetData(sheet, options) {
    const context = {
        ...
        isGM: game.user.isGM,
        toggles: sheet.actor.getFlag('continuum', 'sheetState.toggles') || {},
        timelineSortDirection: sheet.actor.getFlag('continuum', 'timelineSortDirection') || 'desc',
        playersCanSeeSpan: sheet.actor.getFlag('continuum', 'playersCanSeeSpan') ?? false,
        playersCanSeeMetabilities: sheet.actor.getFlag('continuum', 'playersCanSeeMetabilities') ?? false,
        playersCanSeeNaturalSpan: sheet.actor.getFlag('continuum', 'playersCanSeeNaturalSpan') ?? false,
