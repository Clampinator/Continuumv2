...
export function setupRollButtons(html, sheet, content, setVisible, benefitRef) {
    html.find('.roll-attribute, .roll-weapon, .roll-ap, .roll-vehicle').on('click', (e) => {
        ...
        if (isMeta) {
            html.find('.push-slider-background').attr('src', 'systems/continuum/assets/metability-push-slider.png');
            ...
            html.find('.push-slider-background').attr('src', 'systems/continuum/assets/vehicle-speed-slider.png');
