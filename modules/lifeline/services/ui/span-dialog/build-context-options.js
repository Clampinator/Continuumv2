/*
build-context-options.js (Span Dialog)
Generates the HTML for the Context section of the Span Result editor.
...
export function buildContextOptions(actor, currentEraId = null, currentExpId = null, targetAge = 0) {
    ...
    if (!eraId || !allEras[eraId]) {
        return { eraName: 'No Era', eraId: null, experienceOptions: '', lifecycleHtml: '', defaultNewExpName: 'Parallel Project' };
    }
